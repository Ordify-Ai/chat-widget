...
- **Light-only widget chrome**: The widget no longer follows the host page or OS dark mode. That was producing mixed light bubbles on a dark shell (and no way to toggle it). Host `data-theme` styles are ignored.
